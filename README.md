...
This repo contains all the photos taken for the Resolve-Ables project.
...
## View the Devices GitHub Repos

👃 [Visualize AI Nose Classifications With a Light Painting Wearable](https://github.com/ChristianNHill/AI-Nose-LPainting)
